...
export class RepairManager {
    async repair(packageId, projectPath) {
        const verifier = new VerifyManager();
        try {
            await verifier.verify(packageId, projectPath);
            console.log();
            console.log("Package is healthy.");
            console.log("No repair needed.");
            return;
        }
        catch {
            console.log();
            console.log("Repairing package...");
        }
...
//# sourceMappingURL=repairManager.js.map