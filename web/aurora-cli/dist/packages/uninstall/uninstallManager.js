...
export class UninstallManager {
    async uninstall(packageId, projectPath) {
        const inspector = new DependencyInspector();
        const dependents = await inspector.findDependents(packageId);
        if (dependents.length > 0) {
            console.log();
            console.log("Cannot uninstall package.");
            console.log();
        ...
        console.log();
        console.log(`${packageId} removed successfully.`);
        console.log();
    }
}
