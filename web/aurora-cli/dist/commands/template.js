import { getTemplateById, searchTemplates, } from "../services/templateService.js";
import { installProject } from "../services/installService.js";
export async function templateInfoCommand(id) {
...
export async function templateSearchCommand(query) {
...
export async function templateInstallCommand(id, projectName) {
    console.log("");
    console.log("Installing Template");
    console.log("===================");
    const success = await installProject(id, projectName);
    if (!success) {
        return;
    }
    console.log("");
