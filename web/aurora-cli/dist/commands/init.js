...
export async function initCommand() {
    ...
    const config = {
        ...
        installDependencies: await askConfirmation("Install dependencies?"),
        initializeGit: await askConfirmation("Initialize Git repository?"),
    };
    console.log("");
    console.log("=======================================");
    ...
    const frameworkName = await getFrameworkDisplayName(config.framework);
    console.log(`Framework       : ${frameworkName}`);
    console.log(`Language        : ${config.language}`);
    console.log(`Package Manager : ${config.packageManager}`);
    console.log(`Install Dependencies : ${config.installDependencies ? "Yes" : "No"}`);
    console.log(`Initialize Git       : ${config.initializeGit ? "Yes" : "No"}`);
    try {
